...
Here's an example of a [regular link](/blog) that stays within the site.

And here's an [external link to GitHub](https://github.com) — notice the arrow indicator that shows it opens in a new tab.
...
![A beautiful sunset over the mountains](/astro-nano.png)
